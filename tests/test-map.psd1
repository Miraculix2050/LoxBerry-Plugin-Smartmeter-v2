@{
	...
	Groups = @{
		...
		Channels = @("vzlogger-channels", "vzlogger-generator", "vzlogger-validator", "vzlogger-custom-channels")
		Configuration = @("vzlogger-generator", "vzlogger-validator", "vzlogger-expert", "vzlogger-config-validation")
		Runtime = @("vzlogger-runtime", "vzlogger-config-validation")
		Bridge = @("vzlogger-bridge", "vzlogger-http", "loxberry-native-integration", "vzlogger-config-validation")
		Obis = @("obis-status", "vzlogger-channels", "vzlogger-config-validation")
		WebSecurity = @("web-security", "recovery")
		Ui = @("ui-v4", "language-resources", "web-security", "vzlogger-config-validation")
	...
	Rules = @(
		...
		@{ Patterns = @("templates/obis_catalog.json", "templates/meter_templates.json", "bin/SmartMeterVZLoggerChannels.pm", "bin/SmartMeterVZLoggerCustomChannels.pm"); Groups = @("Channels"); Device = "none unless LoxBerry wiring changed"; Browser = "none unless rendered channel behavior changed" }
