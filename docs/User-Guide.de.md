...
Bridge-, Dienststeuerungs-, Weboberflächen- und ausdrücklich angeforderte Diagnoseausgaben verwenden native, zeitgestempelte LoxBerry-Logsitzungen namens `bridge`, `control`, `webui` und `diagnostic`. Sie erscheinen gemeinsam unter **SmartMeter v2 (Plugin Log)** in der zentralen Logverwaltung und teilen deren Plugin-Logstufe. Bei der Standardstufe **Fehler** erzeugen erfolgreiche Aktionen keine leeren Sitzungen mehr; bei Debug spiegelt die Bridge detaillierte Parserausgaben zusätzlich nach `journalctl -u smartmeter-v2-vzlogger-bridge`. Die stündliche LoxBerry-Wartung komprimiert beziehungsweise leert Plugin-Logs ab 3 MiB oder 30 Tagen, löscht komprimierte Dateien nach 60 Tagen und reduziert ein Plugin-Logverzeichnis bei mehr als 100 Dateien auf die neuesten 24 und begrenzt jede registrierte Sitzungsgruppe auf 24 Einträge. **Log anzeigen** und **Steuerungs-Log anzeigen** öffnen die jeweils neueste passende Sitzung, sofern eine vorhanden ist.
